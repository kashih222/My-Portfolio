...
const Navbar = () => {
  ...
  const menuLinks = (
    <motion.ul
      className="flex flex-col md:flex-row md:gap-10 gap-6 text-xl font-semibold md:text-inherit text-white"
      initial={{ opacity: 0 }}
      whileInView={{ opacity: 1 }}
      transition={{ duration: 0.8, delay: 1 }}
    >
      <motion.li className="relative group" whileHover={{ scale: 1.05 }}>
        <a
          href="#home"
      ...
      <motion.li className="md:hidden" whileHover={{ scale: 1.05 }}>
        <a
          href="/resume.pdf"
          download
  ...
  return (
    <div className="w-full fixed top-0 z-50">
      <nav
        className={`flex items-center justify-between px-8 py-3 text-white border-b-2 border-gray-300 transition-all duration-300 ${
          scrolled ? "bg-white/10 backdrop-blur-md" : "bg-green-100/10"
        }`}
      >
